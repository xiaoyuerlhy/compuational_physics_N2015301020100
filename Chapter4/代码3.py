...
plt.plot(x_e,y_e,color='blue',label='Earth',linewidth=0.1)
plt.plot(x_j,y_j,color='black',label='Jupiter',linewidth=0.1)
plt.plot(x_s,y_s,color='red',label='Sun',linewidth=0.1)
